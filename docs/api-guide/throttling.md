...
Может быть ругой сценарий, где вы возможно захотите использовать несколько trottles, если вам понадобится ввести различные ограничения в разных частя API, из-за сервисов которые особенно ресурсоемки.

Multiple throttles can also be used if you want to impose both burst throttling rates, and sustained throttling rates.  For example, you might want to limit a user to a maximum of 60 requests per minute, and 1000 requests per day.
Несколько throttles могут таже использоватся если вы хотите и взорвать throttling рейтинг и продолжать. Для примера, вы может захотите ограничить пользователя 60 запросами в минуту, и 1000 запросами в день.
