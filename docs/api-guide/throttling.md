...
Throttles не обязательно связаны с лимитированием запросов. Для примера сервис хранения данных может нуждаться в ограничении по пропускной способности, а платный сервис может захочет ограничить какое-то количество доступных записей.
