...
Больщую часть времени когда вы имеете дело с валидацией в REST framework вы просто будете полагаться на поля по умолчянию или писать явные валидационные метода в сериализаторах или классах полей.
